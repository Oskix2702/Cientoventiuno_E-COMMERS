      ...
      <div className="mx-auto max-w-[1920px] px-4 pb-20 lg:px-[100px] xl:px-[200px]">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col gap-4 lg:flex-row-reverse lg:gap-6">
            <div className="relative flex-1 overflow-hidden bg-neutral-900 ring-1 ring-white/10">
              {imgError || !resolvedActiveImage ? (
                ...
                <img src={resolvedActiveImage} alt={product.name} onError={() => setImgError(true)} className="h-auto w-full object-contain" />
              )}
              {agotado && (
